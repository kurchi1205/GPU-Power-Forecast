...
def run_train():
    ...
    dataset = PowerDataset("../metrics_log/merged_log.json", seq_len=120, add_power_as_lag=False)
    ...
    trainer = LSTMTrainer(
        ...
        lr=5e-4,
        num_epochs=100,
        checkpoint_dir="checkpoints_seq_len_120_no_power_lag"
    )

    trainer.fit()
    trainer.save("checkpoints_seq_len_120_no_power_lag/gpu_power_lstm.pt")
